...
public class ScrapProjectile implements GameEntity {
    ...
    public ScrapProjectile(Point coordinates, Point velocity, Bitmap bitmap, GameEntity source, Sector sector){
