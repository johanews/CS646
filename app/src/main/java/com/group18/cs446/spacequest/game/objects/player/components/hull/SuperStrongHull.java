...
public class SuperStrongHull implements Hull {
    private static final String NAME = "Very Very Strong Hull";
    private static final String DESCRIPTION = "Stronger than the others";
    ...
    public SuperStrongHull(Context context){
        this.maxHealth = 800;
    ...
    public void update(long gameTick) {
        ...
        } else if (lastDamageTick + regenCooldown < gameTick && gameTick % 25 == 0){
    ...
    @Override
    public Hulls ID() {
        return Hulls.VERY_VERY_STRONG_HULL;
    }
    ...
    public int getImageID() {
        return R.drawable.item_hull_superstrong;
    }
}
