...
public class HealthBar implements HUDComponent {
    ...
    public HealthBar(Player player){
        ...
        fillPaint = new Paint();
        fillPaint.setColor(Color.argb(155, 255, 10, 10));
        update();
    }
    ...
    public void update() {
        ...
        message = currentHealth +"/"+maxHealth;
        ...
        fillCoords[1].set(topLeft.x +(width*currentHealth/maxHealth),
                topLeft.y);
        fillCoords[2].set(topLeft.x +((width - 50)*currentHealth/maxHealth),
                topLeft.y+height);
  }
